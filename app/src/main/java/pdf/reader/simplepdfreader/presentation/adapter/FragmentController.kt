...
class FragmentController(activity: AppCompatActivity) {
    ...
    private var fragmentAdapter: FragmentAdapter = FragmentAdapter(activity.supportFragmentManager,activity.lifecycle)
    ...
    init {
        ...
        TabLayoutMediator(tabLayout,viewPager2){tab, position ->
            when(position){
                ...
                1 -> tab.icon = activity.resources.getDrawable(R.drawable.ic_baseline_turned_in_not_24)
                2 -> tab.icon = activity.resources.getDrawable(R.drawable.ic_baseline_local_fire_department_24)
                3 -> tab.icon = activity.resources.getDrawable(R.drawable.ic_baseline_access_time_24)
